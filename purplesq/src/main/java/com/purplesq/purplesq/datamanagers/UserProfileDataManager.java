...
public class UserProfileDataManager {
    ...
    public static final int GET_DOB = 5;
    public static final int GET_GENDER = 6;
    public static final int GET_INSTITUTE = 7;
    public static final int GET_IMAGEURL = 8;
    public static final int GET_ROLE = 9;
    ...
    public static UserVo getUserProfile(Context context) {
        ...
        try {
            ...
            if ((cur != null) && cur.moveToFirst()) {
                ...
                userVo.setDob(cur.getString(GET_DOB));
