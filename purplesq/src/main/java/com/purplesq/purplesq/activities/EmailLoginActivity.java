...
public class EmailLoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor>, GenericAsyncTaskListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPasswordView = (EditText) findViewById(R.id.activity_email_login_et_password);
...
//        });
        ...
        mLoginFormView = findViewById(R.id.activity_email_login_form);
        mProgressView = findViewById(R.id.activity_email_login_progress);
    }
    ...
    public void onLoadFinished(Loader<Cursor> cursorLoader, Cursor cursor) {
        ...
        cursor.moveToFirst();
        Log.i("Nish", "Cursor count : " + cursor.getCount());
